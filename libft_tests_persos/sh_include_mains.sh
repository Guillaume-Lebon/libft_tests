...
then
	...
	rm -f ../ft_atoi ../ft_calloc ../ft_isascii ../ft_itoa ../ft_memcmp ../ft_memset ../ft_putnbr_fd ../ft_strchr ../ft_strlcat
	rm -f ../ft_strmapi ../ft_strrchr ../ft_tolower ../putendl_fd.txt ../ft_bonus ../ft_isalnum ../ft_isdigit ../ft_memccpy
	rm -f ../ft_memcpy ../ft_putchar_fd ../ft_putstr_fd ../ft_strdup ../ft_strlcpy ../ft_strncmp ../ft_strtrim ../ft_toupper
	rm -f ../putnbr_fd.txt ../ft_bzero ../ft_isalpha ../ft_isprint ../ft_memchr ../ft_memmove ../ft_putendl_fd ../ft_split
	rm -f ../ft_strjoin ../ft_strlen ../ft_strnstr ../ft_substr ../putchar_fd.txt ../putstr_fd.txt
	exit
fi
