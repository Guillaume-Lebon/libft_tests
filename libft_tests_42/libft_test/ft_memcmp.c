...
static void validate_memcmp(void *s1, void *s2, size_t n, int f);
...
Test(ft_memcmp, same_ptr)
{
	char buf[10] = "0123456789";

	validate_memcmp(buf, buf, 10, false);
}

Test(ft_memcmp, len0)
{
	validate_memcmp((void *)42, (void *)4242, 0, false);
}
...
void validate_memcmp(void *s1, void *s2, size_t n, int f)
{
	int ret0, ret1;
