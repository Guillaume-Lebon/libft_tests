...
static void validate_strncmp(void *s1, void *s2, size_t n, int f);
...
Test(ft_strncmp, same_ptr)
{
	char *str0 = "01234";

	validate_strncmp(str0, str0, strlen(str0) + 1, false);
}
...
void validate_strncmp(void *s1, void *s2, size_t n, int f)
{
	int ret0, ret1;
