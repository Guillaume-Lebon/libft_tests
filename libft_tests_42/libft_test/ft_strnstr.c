...
{
	static char buf[11] = "0123456789\0";
	static t_strnstr_param data[] = {
		...
		{ .haystack = "0123456789", .needle  = "345", .n = 10 },
		{ .haystack = "0123456789", .needle  = "@@@", .n = 42 },
		...
		{ .haystack = "abbababbababbabbabababbaba", .needle  = "abbabbaba",
		  .n = 27 },
		{ .haystack = buf, .needle = buf, .n = 10 },
	};
...
static void validate_strnstr(void *haystack, void *needle, size_t len, int f)
{
	void *ret0, *ret1;
